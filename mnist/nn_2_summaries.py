...
def main():
    log_dir = '/tmp/mnist/nn_2_summaries'
    ...
    with tf.name_scope('layer_2'):
        W2 = tf.Variable(tf.truncated_normal([num_neurons_1, K], stddev=1.0 / math.sqrt(float(num_neurons_1))), name='weights')
        b2 = tf.Variable(tf.zeros([K]), name='bias')
