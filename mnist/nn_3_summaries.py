...
def main():
    log_dir = '/tmp/mnist/nn_3_summaries'
    ...
    with tf.name_scope('layer_3'):
        W3 = tf.Variable(tf.truncated_normal([num_neurons_2, K], stddev=1.0 / math.sqrt(float(num_neurons_2))), name='weights')
        b3 = tf.Variable(tf.zeros([K]), name='bias')
